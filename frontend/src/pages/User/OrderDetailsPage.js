        ...
        <div className="w-full bg-white">
          ...
          <div className="flex">
            ...
            {data.paymentTrasaction !== null ? (
              <h2 className="text-lg text-right font-bold py-3 pl-5 text-darkblue">
                  ...
                  return (
                    <tr>
                      ...
                      <td className="text-right pb-3">
                        <span className="text-sm lg:text-base font-bold text-darkblue">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <Link to="#">
                            {data.status === "unpaid" ? (
                              <p className="mb-4 md:ml-4 text-darkblue font-bold">
                  ...
                  <table align="center">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <Link to="#">
                            <p className="mb-4 md:ml-4 text-darkblue font-semibold text-right">
                      ...
                      <tr>
                        ...
                        <td>
                          <Link to="#">
                            <p className="mb-4 md:ml-4 font-semibold text-darkblue text-right">
                      ...
                      <tr>
                        ...
                        <td>
                          <Link to="#">
                            <p className="mb-4 md:ml-4 font-bold text-darkblue text-right">
